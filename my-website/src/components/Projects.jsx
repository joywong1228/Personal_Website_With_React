      ...
      <div className="experience-details-container">
        <div className="about-containers">
          <div className="details-container color-container">
            ...
            <h2 className="experience-sub-title project-title">Flappy Bird - Anime Version</h2>
          ...
          <div className="details-container color-container">
            ...
            <h2 className="experience-sub-title project-title">Personal Website (Current Page)</h2>
          ...
          <div className="details-container color-container">
            ...
            <h2 className="experience-sub-title project-title">Simply Personal Website</h2>
